...
const exerciseData = [
  {
    ...
    category: "Shoulders",
    instructions:
      "Sit on a bench with back support, holding a dumbbell in each hand at shoulder height. Press the dumbbells upward until your arms are fully extended. Lower them back slowly and repeat.",
  },
  {
    ...
    category: "Shoulders",
    instructions:
      "Stand with feet shoulder-width apart, holding a barbell at shoulder level. Press it overhead, extending your arms fully, then slowly lower it back to the starting position.",
  },
  {
    name: "Arnold Press",
    type: "strength",
    ...
    category: "Shoulders",
    instructions:
      "Hold dumbbells at shoulder height with palms facing you. Rotate your palms outward as you press up, fully extending your arms. Lower back to the start position with control.",
  },
  {
    name: "Lateral Raises",
    type: "strength",
    ...
    category: "Shoulders",
    instructions:
      "Hold dumbbells at your sides, keeping a slight bend in the elbows. Lift them laterally to shoulder height, then lower them back slowly.",
  },
  {
    name: "Front Raises",
    type: "strength",
    ...
    category: "Shoulders",
    instructions:
      "Hold a dumbbell in each hand in front of your thighs. Raise one or both arms forward to shoulder height, then lower back slowly.",
  },
  {
    ...
    category: "Shoulders",
    instructions:
      "Sit on a pec deck machine facing the pads. Grasp the handles with arms extended, then pull them outward and back to squeeze the rear delts.",
  },
  {
    name: "Face Pulls",
    type: "strength",
    ...
    category: "Shoulders",
    instructions:
      "Attach a rope to a high pulley. Pull the rope towards your face while keeping elbows high, squeezing the rear delts at the end.",
  },
  {
    ...
    category: "Shoulders",
    instructions:
      "Attach a cable to the lowest setting and grab the handle with the opposite hand. Lift your arm laterally to shoulder height, then lower back slowly.",
  },
  {
    ...
    category: "Shoulders",
    instructions:
      "Bend at the waist, holding dumbbells in front of you. Lift your arms outward to the sides, squeezing your rear delts at the top, then lower slowly.",
  },
  {
    name: "Landmine Press",
    type: "strength",
    ...
    category: "Shoulders",
    instructions:
      "Secure one end of a barbell on the floor. Hold the other end with one hand at shoulder height, press up, then slowly lower it back.",
  },
  {
    name: "Z-Press",
    type: "strength",
    ...
    category: "Shoulders",
    instructions:
      "Sit on the floor with legs extended straight. Hold a barbell at shoulder height and press it overhead, keeping your core engaged.",
  },
  {
    name: "Bradford Press",
    type: "strength",
    ...
    category: "Shoulders",
    instructions:
      "Hold a barbell at shoulder height. Press it just over your head, then bring it behind your head, then back to the front. Repeat continuously.",
  },
  {
    ...
    category: "Shoulders",
    instructions:
      "Hold a dumbbell at shoulder height with one arm. Press it overhead, keeping your core engaged, then slowly lower it back.",
  },
  {
    ...
    category: "Shoulders",
    instructions:
      "Sit on a shoulder press machine and grab the handles. Press upward until your arms are fully extended, then lower back slowly.",
  },
  {
    ...
    category: "Shoulders",
    instructions:
      "Hold a barbell behind your head at shoulder height. Press it overhead, then lower it back carefully. Avoid this exercise if you have shoulder issues.",
  },
  {
    name: "Bus Driver Exercise",
    type: "strength",
    muscle: "shoulders",
    ...
    category: "Shoulders",
    instructions:
      "Hold a weight plate in front of you with both hands. Rotate it side to side like turning a steering wheel.",
  },
  {
    name: "Upright Rows",
    type: "strength",
    ...
    category: "Shoulders",
    instructions:
      "Hold a barbell with an overhand grip. Pull it up towards your chin, keeping elbows high, then lower back slowly.",
  },
  {
    name: "Y-Raises",
    type: "strength",
    ...
    category: "Shoulders",
    instructions:
      "Lie face down on an incline bench, holding light dumbbells. Raise your arms in a Y-shape above your head, then lower back slowly.",
  },
  {
    ...
    category: "Shoulders",
    instructions:
      "Hold a dumbbell in each hand by your sides. Shrug your shoulders upward, hold briefly, then lower them back down.",
  },
  {
    ...
    category: "Shoulders",
    instructions:
      "Hold a trap bar at shoulder height. Press it overhead, extending your arms fully, then lower back to the start.",
  },
];
